...
function agregarDeseo(idProducto) {
  ...
  alertaPersonalizado("agregao a tu lista de deseo", "success");
  cantidadDeseo();
}
...
function agregarCarrito(idProducto, cantidad) {
  if (localStorage.getItem("listaCarrito") == null) {
    ...
    for (let i = 0; i < listaExiste.length; i++) {
      if (listaExiste[i]["idProducto"] == idProducto) {
        alertaPersonalizado("producto ya agregado al carrito", "warning");
        return;
      }
    }
  ...
  alertaPersonalizado("producto   agregado al carrito", "success");
  cantidadCarrito();
}
...
function eliminarListaCarrito(idProducto) {
  ...
  getListaCarrito();
  cantidadCarrito();
  alertaPersonalizado("Producto eliminado de tu carrito", "success");


}

function alertaPersonalizado(mensaje, type) {
  Command: toastr[type](mensaje, "mensaje");
